...
?>
	<tr>
		...
		<td width="44">
			<div align="center">
				<a href="../../modules/loaitin/index.php?quanli=loaitin&amp;ac=sua&amp;id=<? echo $dong["postid"]?>">
        			<img src="../../modules/loaitin/img/b_edit.png" />
       			</a> 
        	</div>
		</td>	
        <td width="41"><a href="../../modules/loaitin/modules/loaitin/xuly.php?xoa=loaitin&amp;id=<? echo $dong["postid"]?>"><img src="../../modules/loaitin/img/b_drop.png" /></a></td>
	</tr>
<?
	}
?>
